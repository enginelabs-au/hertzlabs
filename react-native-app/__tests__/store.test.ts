  ...
  it('persists only durable slices and never ephemeral runtime/audio state', () => {
    ...
    expect(keys).toEqual(
      [
        ...
        'appLaunchCount',
        'appliedPromoCode',
        'appliedPromoEntitlement',
        'appliedPromoExpiresAt',
        'asmrEnabled',
        'asmrStemMix',
        'backgroundAudio',
        'beatSliderScale',
        ...
        'lastStreakDate',
        'lastUsedParams',
        'lastWellnessCheckinDate',
        'myReferralCode',
        'onboardingDone',
        'paywallNudgeDismissedAtLaunch',
        'paywallSoftPromptShown',
        'peakStreakDays',
        'pendingReferrerCode',
        'photicStrobeConsentGiven',
        'photicStrobeEnabled',
        'postRewardGranted',
        'postSubmissionPending',
        'practitionerRewardGranted',
        'practitionerSubmissionPending',
        'premiumGiftDayBeforeDismissedAtLaunch',
        'premiumGiftExpiryDayDismissedAtLaunch',
        'promoClaimResetEpoch',
        'promotionalOffersEnabled',
        'reviewPromptedForVersion',
        'reviewRewardClaimed',
        'shareLinkRewardClaimed',
        'streakBonusMilestonesClaimed',
        'streakBreakEpisodeId',
        'streakDays',
        'streakRemindersEnabled',
        'streakRestoreDeclinedAtMs',
